                ...
                .Contains(c):
                    {
                        builder.Description = $"Команда **{messageCommands[MessagesEnum.Help][0]}** " +
                            ...
                            $"щоб переглянути використання параметру для команди чи інші відомості по команді.\n" +
                            $"\nБойова група:\n" +
                            $"<@228896926991515649> - автор **{_client.CurrentUser.Username}**\n" +
                ...
                .Contains(c):
                    {
                        builder.Description = $"Команда **{messageCommands[MessagesEnum.Weekly][0]}** " +
                            ...
                            $"яка надсилається автоматично на початку кожного тижня у Destiny 2.\n" +
