                ...
                case "музика" or "music":
                    {
                        ...
                        builder.Description = "Відтворює звук із заданого відео чи плейлисту в YouTube.\n" +
                            "Перед використанням команди відтворення ви маєте бути під'єднані до голосового каналу, щоби бот знав, куди під'єднуватися.\n" +
                            "\nНаявні 3 типи команд:\n" +
                            "**play** ***%URL%*** – під'єднується до голосового каналу та відтворює звук зі вказаного відео.\n" +
                            "**playlist** ***%URL%*** – під'єднується до голосового каналу та відтворює звук зі вказаного плейлисту.\n" +
                            ...
                            "Не підтримуються живі етери та відео, які вимагають авторизації для підтвердження віку.";
